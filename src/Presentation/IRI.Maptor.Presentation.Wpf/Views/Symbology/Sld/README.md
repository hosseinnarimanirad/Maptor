...
> **Namespaces:** views live in `IRI.Maptor.Presentation.Wpf.Controls.Symbology.Sld`; view-models live in `IRI.Maptor.Presentation.Wpf.ViewModels.Symbology`.

## Components

### ViewModels (`ViewModels/Symbology/Sld/`, namespace `IRI.Maptor.Presentation.Wpf.ViewModels.Symbology`)
...
```csharp
using IRI.Maptor.Presentation.Wpf.Controls.Symbology.Sld;   // Views (SldEditorWindow, SldEditorView, ...)
using IRI.Maptor.Presentation.Wpf.ViewModels.Symbology; // ViewModels (SldEditorViewModel, ...)
...
```xml
<!-- In your XAML -->
<Window xmlns:sld="clr-namespace:IRI.Maptor.Presentation.Wpf.Controls.Symbology.Sld">
    <Grid>
...
- **Commands** using `RelayCommand` from `IRI.Maptor.Presentation.Wpf`
- **Template selectors** for dynamic view selection

## Dependencies

- `IRI.Maptor.Core.Ogc` - SLD data model
- `IRI.Maptor.Presentation.Wpf` - Base classes and utilities
...
See also:
- `IRI.Maptor.Core.Ogc.SLD` namespace for the underlying data model (and `SldHelper` for read/write)
- `IRI.Maptor.Core.Ogc` for OGC filter classes (`OgcFilter`, `OgcPropertyIsEqualTo`, ...)
- `IRI.Maptor.Presentation.Core.Notifier` for the MVVM base class

---
[Back to IRI.Maptor.Presentation.Wpf](../../../README.md)
