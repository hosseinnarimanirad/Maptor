...
- **Added reference** to `IRI.Maptor.Core.Ogc` in `IRI.Maptor.Presentation.Wpf.csproj`
...
```csharp
using IRI.Maptor.Presentation.Wpf.Controls.Symbology.Sld;
...
<Window xmlns:sld="clr-namespace:IRI.Maptor.Presentation.Wpf.Controls.Symbology.Sld"
        xmlns:vm="clr-namespace:IRI.Maptor.Presentation.Wpf.ViewModels.Symbology;assembly=IRI.Maptor.Presentation.Wpf">
    <Window.DataContext>
...
- Modified: `IRI.Maptor.Presentation.Wpf.csproj` (added Ogc project reference)
...
For questions or enhancement requests, refer to the main IRI.Maptor documentation or the existing SLD implementation in `IRI.Maptor.Core.Ogc.SLD` namespace.
