...
public partial class InputCoordinate : UserControl
{
    ...
    private void save_Click(object sender, RoutedEventArgs e)
    {
        ...
        //{
        //    this.Presenter.PointCollection.Add(new IRI.Maptor.Core.Common.Primitives.Point(x, y));
        //}
    ...
    private void remove_Click(object sender, RoutedEventArgs e)
    {
        ...
        //this.Presenter.PointCollection.Remove(button.DataContext as IRI.Maptor.Core.Common.Primitives.Point);
    }
