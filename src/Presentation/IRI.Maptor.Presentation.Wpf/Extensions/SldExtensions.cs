...
public static class SldExtensions
{
    ...
    /// </summary>
    public static StyledLayerDescriptor ParseToSld(this IEnumerable<ISymbolizer> symbolizers, IRI.Maptor.Presentation.Core.SpatialModelMode? spatialModelMode = null)
    {
    ...
    private static Symbolizer? ToSldSymbolizer(ISymbolizer symbolizer, IRI.Maptor.Presentation.Core.SpatialModelMode? spatialModelMode = null)
    {
    ...
    private static Symbolizer ToSimpleSymbolizer(SimpleSymbolizer symbolizer, IRI.Maptor.Presentation.Core.SpatialModelMode? spatialModelMode = null)
    {
        ...
        {
            case IRI.Maptor.Presentation.Core.SpatialModelMode.Point:
                return ToPointSymbolizer(param);

            case IRI.Maptor.Presentation.Core.SpatialModelMode.Polygon:
            ...
            case IRI.Maptor.Presentation.Core.SpatialModelMode.Polyline:
