...
public static class PointExtensions
{
    ...
    public static IRI.Maptor.Core.Common.Primitives.Point AsPoint(this System.Windows.Point point)
    {
        return new IRI.Maptor.Core.Common.Primitives.Point(point.X, point.Y);
    }
}
