...
public class ReviewFunctions
{
    ...
    /// </summary>
    public Action<IRI.Maptor.Core.Spatial.Primitives.Geometry<IRI.Maptor.Core.Common.Primitives.Point>?, IRI.Maptor.Core.Spatial.Primitives.Geometry<IRI.Maptor.Core.Common.Primitives.Point>?>? ShowGeometryComparison { get; set; }
}
