...
using IRI.Maptor.Presentation.Wpf.Models.DxfOpenDialog;
using IRI.Maptor.Core.Common.Exceptions;
using System.IO;
using IRI.Maptor.Presentation.Core.Localization;

namespace IRI.Maptor.Presentation.Wpf.ViewModels.Dialogs;
...
public class DxfOpenDialogViewModel : DialogViewModelBase
{
    ...
    {
        get => _filePath;
        set { _filePath = value ?? string.Empty; RaisePropertyChanged(); RaisePropertyChanged(nameof(ValidationMessage)); }
    }
    ...
    public string? ValidationMessage
    {
        get
        {
            if (string.IsNullOrWhiteSpace(FilePath))
                return LocalizationManager.Instance["dialog_common_validationNoFile"];
