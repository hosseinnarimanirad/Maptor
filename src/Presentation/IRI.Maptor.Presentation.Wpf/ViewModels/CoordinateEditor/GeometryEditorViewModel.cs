...
namespace IRI.Maptor.Presentation.Wpf.ViewModels.CoordinateEditor;
...
public class GeometryEditorViewModel : Notifier
{
    ...
    public bool IsRingBase =>
            GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.Polygon ||
            GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.MultiPolygon;

    //public bool IsMultiGeometry => GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.MultiPoint ||
    //                                GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.MultiLineString ||
    //                                GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.MultiPolygon;
    ...
    private List<IGeometry>? Parts => GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.MultiPolygon ?
    ...
    private List<IGeometry>? Polygons => GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.MultiPolygon ?
    ...
    private int GetGlobalIndex(int localIndex)
    {
        ...
        if (GeometryType == IRI.Maptor.Core.Common.Enums.GeometryType.MultiPolygon)
    ...
    //    var newLocateable = FeatureLayer.InsertVertexAt(new IRI.Maptor.Core.Common.Primitives.Point(0, 0), globalIndex);
    ...
    private Point GetNewPoint()
    {
        ...
        if (SrsViewModel.SelectedSrsType == IRI.Maptor.Core.SpatialReferenceSystem.CoordinateDisplayMode.GeodeticDms)
        {
