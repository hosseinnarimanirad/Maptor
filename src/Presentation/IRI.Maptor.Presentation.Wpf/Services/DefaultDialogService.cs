...
#pragma warning restore CS8978
    ...
    public Task<string?> ShowOpenFolderDialogAsync(object? ownerWindow = null)
    {
        ...
        {
            Multiselect = false,
            Title = LocalizationManager.Instance[nameof(IRI.Maptor.Presentation.Core.Properties.Resources.dialog_openfile_title)]
        };
    ...
    //        Title = LocalizationManager.Instance[nameof(IRI.Maptor.Presentation.Core.Properties.Resources.dialog_savefile_title)]
    //    };
    ...
    public Task ShowMessageAsync(string message, string? title, object? ownerWindow = null, string? pathMarkup = null)
    {
        ...
        {
            Message = message,
            Title = title ?? LocalizationManager.Instance[nameof(IRI.Maptor.Presentation.Core.Properties.Resources.dialog_showMessage_title)],
            IsTwoOptionsMode = false,
            IconPathMarkup = pathMarkup ?? markup,
            FirstOptionPathMarkup = okPath
        };

        MessageBoxView dialog = new MessageBoxView();
    ...
    public Task<ChangePasswordDialogViewModel?> ShowChangePasswordDialog(object? ownerWindow, ChangePasswordDialogViewModel viewModel)
    {
        ...
        ChangePasswordDialogView dialog = new ChangePasswordDialogView();
    ...
    public Task<CsvTsvOptions?> ShowCsvTsvOpenDialogAsync(object? ownerWindow = null, bool initialIsCsv = true, int? initialSrid = null)
    {
        ...
        var dialog = new CsvTsvOpenDialogView();
