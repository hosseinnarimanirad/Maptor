...
//using static IRI.Maptor.Presentation.Wpf.Models.Themes.MahAppsThemeColor;
    ...
    public static void ApplyTheme(MahAppsThemeColor? color, ThemeMode? mode = null)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                var statusPath = $"pack://application:,,,/IRI.Maptor.Presentation.Wpf;component/Assets/Styles/Status.{baseTheme}.xaml";
