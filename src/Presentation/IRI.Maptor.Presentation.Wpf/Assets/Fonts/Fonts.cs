...
namespace IRI.Maptor.Presentation.Wpf.Assets.Fonts;
...
public static class IriFonts
{
    ...
    private static FontFamily _iranSans = new FontFamily(new Uri(@"pack://application:,,,/IRI.Maptor.Presentation.Wpf;component/Assets/Fonts/", UriKind.Absolute), "./#IRANSans");
