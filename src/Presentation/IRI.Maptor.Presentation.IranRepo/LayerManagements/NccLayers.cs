...
public static class NccLayers
{
    ...
    public static ObservableCollection<ILayer> GetLayers(MapViewModelBase map)
    {
        ...
        var leveling1 = NccRepository.GetLayer(
            "leveling1", 
            IRI.Maptor.Presentation.Core.Properties.Resources.layer_leveling1_title,
        ...
        var leveling2 = NccRepository.GetLayer("leveling2",
            IRI.Maptor.Presentation.Core.Properties.Resources.layer_leveling2_title,
        ...
        var leveling3 = NccRepository.GetLayer("leveling3",
            IRI.Maptor.Presentation.Core.Properties.Resources.layer_leveling3_title,
        ...
        var geodesy1 = NccRepository.GetLayer("geodesy1", 
            IRI.Maptor.Presentation.Core.Properties.Resources.layer_geodesy1_title,
        ...
        var geodesy2 = NccRepository.GetLayer("geodesy2", 
            IRI.Maptor.Presentation.Core.Properties.Resources.layer_geodesy2_title,
        ...
        var gravity = NccRepository.GetLayer("gravity",
            IRI.Maptor.Presentation.Core.Properties.Resources.layer_gravimetry_title,
        ...
        var geodynamic = NccRepository.GetLayer("geodynamic", 
            IRI.Maptor.Presentation.Core.Properties.Resources.layer_geodynamics_title,
