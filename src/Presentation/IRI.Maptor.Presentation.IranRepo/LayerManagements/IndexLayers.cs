...
using IRI.Maptor.Core.Spatial.MapIndexes;
...
public static class IndexLayers
{
    ...
    public static VectorLayer GetIndex250kLayer()
    {
        ...
        //"اندکس ۲۵۰ هزار", 
        return new VectorLayer(
            IRI.Maptor.Presentation.Core.Properties.Resources.index_250k_title,
            source,
    ...
    public static VectorLayer GetIndex100kLayer()
    {
        ...
        return new VectorLayer(
            //"اندکس ۱۰۰ هزار", 
            IRI.Maptor.Presentation.Core.Properties.Resources.index_100k_title,
            source,
    ...
    public static VectorLayer GetIndex50kLayer()
    {
        ...
        return new VectorLayer(
            //"اندکس ۵۰ هزار", 
            IRI.Maptor.Presentation.Core.Properties.Resources.index_50k_title,
            source,
            [symbolizer,],
            LayerType.VectorLayer,
            RenderMode.Default,
    ...
    public static VectorLayer GetIndex25kLayer()
    {
        ...
        return new VectorLayer(
            //"اندکس ۲۵ هزار", 
            IRI.Maptor.Presentation.Core.Properties.Resources.index_25k_title,
            source,
            [symbolizer,],
            LayerType.VectorLayer,
            RenderMode.Default,
    ...
    public static VectorLayer Get2kDynamicIndexBlock(MapViewModelBase map, int utmZone)
    {
        ...
        var layer =
            new VectorLayer(
                //"بلوک‌های ۲ هزار",
                IRI.Maptor.Presentation.Core.Properties.Resources.index_2kblocks_title,
                source,
                [symbolizer, label],
                LayerType.VectorLayer,
                RenderMode.Default,
    ...
    public static VectorLayer Get2kDynamicIndexSheet(MapViewModelBase map, int utmZone)
    {
        ...
        var layer =
            new VectorLayer(
                //"اندکس ۲ هزار",
                IRI.Maptor.Presentation.Core.Properties.Resources.index_2kUtm_title,
                source,
                [symbolizer, label],
                LayerType.VectorLayer,
                RenderMode.Default,
    ...
    public static VectorLayer Get1kDynamicIndex(MapViewModelBase map, int utmZone)
    {
        ...
        var layer =
            new VectorLayer(
                //"اندکس ۱ هزار",
                IRI.Maptor.Presentation.Core.Properties.Resources.index_1kUtm_title,
                source,
                [symbolizer, label],
                LayerType.VectorLayer,
                RenderMode.Default,
    ...
    public static VectorLayer Get500DynamicIndex(MapViewModelBase map, int utmZone)
    {
        ...
        var layer =
            new VectorLayer(
                //"اندکس ۵۰۰",
                IRI.Maptor.Presentation.Core.Properties.Resources.index_500Utm_title,
                source,
                [symbolizer, label],
                LayerType.VectorLayer,
                RenderMode.Default,
    ...
    public static VectorLayer Get10kDynamicIndex(MapViewModelBase map)
    {
        ...
        var layer10k =
            new VectorLayer(
                //"اندکس ۱۰ هزار",
                IRI.Maptor.Presentation.Core.Properties.Resources.index_10k_title,
    ...
    public static VectorLayer Get5kDynamicIndex(MapViewModelBase map)
    {
        ...
        var layer5k =
            new VectorLayer(
                //"اندکس ۵ هزار",
                IRI.Maptor.Presentation.Core.Properties.Resources.index_5k_title,
