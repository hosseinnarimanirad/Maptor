...
public class PointCollection : IEnumerable<Point>
{
    ...
    /*Sort
    //public void Sort(IRI.Maptor.Core.Common.DataStructures.SortDirection direction, PointComparisonPriority priority)
    //{
    //    Point.ComparisonPriority = priority;

    //    IRI.Maptor.Core.Common.DataStructures.SortAlgorithm.Heapsort<Point>(ref this.points, direction);
