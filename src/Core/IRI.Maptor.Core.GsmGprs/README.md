# IRI.Maptor.Core.GsmGprs

[![NuGet](https://img.shields.io/nuget/v/IRI.Maptor.Core.GsmGprs?logo=nuget)](https://www.nuget.org/packages/IRI.Maptor.Core.GsmGprs/)
...
```bash
dotnet add package IRI.Maptor.Core.GsmGprs
```
...
```csharp
using IRI.Maptor.Core.GsmGprs;
using IRI.Maptor.Core.GsmGprs.AddressField;
...
---
[NuGet package](https://www.nuget.org/packages/IRI.Maptor.Core.GsmGprs/) · [Report issues](https://github.com/hosseinnarimanirad/Maptor/issues) · [Back to IRI.Maptor.Core](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/Core/README.md)
