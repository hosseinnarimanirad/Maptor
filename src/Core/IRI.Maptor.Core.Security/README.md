...
[![NuGet](https://img.shields.io/nuget/v/IRI.Maptor.Core.Security?logo=nuget)](https://www.nuget.org/packages/IRI.Maptor.Core.Security/)
...
---
[NuGet package](https://www.nuget.org/packages/IRI.Maptor.Core.Security/) · [Report issues](https://github.com/hosseinnarimanirad/Maptor/issues) · [Back to IRI.Maptor.Core](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/Core/README.md)
