...
public class GreedyClustering<TNode, TWeight>
{
    ...
    IRI.Maptor.Core.Common.DataStructures.BinaryHeap<Edge<TNode, TWeight>> mostDesiredPairs;
    ...
    private void Initialize()
    {
        ...
        this.mostDesiredPairs = new IRI.Maptor.Core.Common.DataStructures.BinaryHeap<Edge<TNode, TWeight>>(graph.GetEdges().ToArray(), compareFunction);
    }
