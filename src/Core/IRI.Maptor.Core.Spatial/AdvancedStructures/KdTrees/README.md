...
`KdTree.cs`, `KdTreeNode.cs` — the plain tree. `BalancedKdTree.cs`, `BalancedKdTreeNode.cs` — the balanced one. All four live in namespace `IRI.Maptor.Core.Spatial.AdvancedStructures`.
