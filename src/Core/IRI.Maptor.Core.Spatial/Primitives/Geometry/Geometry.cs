...
public class Geometry<T> : IGeometry where T : IPoint, new()
{
    ...
    {
        return IRI.Maptor.Core.Common.Helpers.HexStringHelper.ToHexStringUsingBitFiddle(AsWkb(), append0x: true);
    }
    ...
    // Note: GML conversion methods are implemented as extension methods in IRI.Maptor.Core.Ogc.Extensions.Sta_GmlExtensions
