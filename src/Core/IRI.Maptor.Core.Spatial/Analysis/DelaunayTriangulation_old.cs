...
//[Obsolete("Broken vertex-code keying: relies on Point.GetHashCode() as vertex ids while PointCollection keys points by sequential codes. Use DelaunayTriangulation instead.")]
//public class DelaunayTriangulation_old
//{
...
//    public DelaunayTriangulation_old(PointCollection points)
//    {
//        if (points.Count < 3)
...
//            if (IRI.Maptor.Core.Common.Mathematics.Statistics.GetMax(firstSetAngle) > IRI.Maptor.Core.Common.Mathematics.Statistics.GetMax(secondSetAngle) &&
//                IRI.Maptor.Core.Common.Mathematics.Statistics.GetMin(firstSetAngle) < IRI.Maptor.Core.Common.Mathematics.Statistics.GetMin(secondSetAngle))
//            {
