...
public class EsriJsonGeometry
{
    ...
    //    if (HasM == true)
    //    {
    //        return Geometry<IRI.Maptor.Core.Common.Primitives.PointZM>.FromWkt(this.AsWkt(), srid);
    //    }
    //    else if (HasZ == true)
    //    {
    //        return Geometry<IRI.Maptor.Core.Common.Primitives.PointZ>.FromWkt(this.AsWkt(), srid);
    //    }
    //    else
    //    {
    //        return Geometry<IRI.Maptor.Core.Common.Primitives.Point>.FromWkt(this.AsWkt(), srid);
    //    }
    //}
