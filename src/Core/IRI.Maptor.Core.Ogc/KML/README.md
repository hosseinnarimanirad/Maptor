...
OGC KML 2.2: a tree of placemarks, folders and shared styles for the globe. All classes live in the `IRI.Maptor.Core.Ogc.Kml` namespace (not `Core.Ogc.KML`), and KML's convention is WGS84 (SRID 4326) throughout.
