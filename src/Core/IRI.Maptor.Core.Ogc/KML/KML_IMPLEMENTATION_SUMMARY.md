...
### 1. **KmlReader.cs** (`src/Core/IRI.Maptor.Core.Ogc/KML/KmlReader.cs`)
...
### 2. **KmlWriter.cs** (`src/Core/IRI.Maptor.Core.Ogc/KML/KmlWriter.cs`)
...
### 3. **KmlStyleBuilder.cs** (`src/Core/IRI.Maptor.Core.Ogc/KML/KmlStyleBuilder.cs`)
...
### 4. **KmlValidator.cs** (`src/Core/IRI.Maptor.Core.Ogc/KML/KmlValidator.cs`)
...
### 5. **KmlExtensions.cs** (`src/Core/IRI.Maptor.Core.Spatial/Extensions/KmlExtensions.cs`)
...
### 6. **Updated KmlDecorator.cs** (`src/Core/IRI.Maptor.Core.Ogc/KML/KmlDecorator.cs`)
...
### 7. **README.md** (`src/Core/IRI.Maptor.Core.Ogc/KML/README.md`)
...
IRI.Maptor.Core.Spatial/Extensions/
...
- `IRI.Maptor.Core.Common` - XmlHelper, Point, BoundingBox
- `IRI.Maptor.Core.Spatial` - Geometry classes
- `IRI.Maptor.Core.Ogc.Kml.Primitives` - Auto-generated KML types
