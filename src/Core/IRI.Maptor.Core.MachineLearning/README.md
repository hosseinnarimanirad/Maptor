...
[![NuGet](https://img.shields.io/nuget/v/IRI.Maptor.Core.MachineLearning?logo=nuget)](https://www.nuget.org/packages/IRI.Maptor.Core.MachineLearning/)
...
---
[NuGet package](https://www.nuget.org/packages/IRI.Maptor.Core.MachineLearning/) · [Report issues](https://github.com/hosseinnarimanirad/Maptor/issues) · [Back to IRI.Maptor.Core](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/Core/README.md)
