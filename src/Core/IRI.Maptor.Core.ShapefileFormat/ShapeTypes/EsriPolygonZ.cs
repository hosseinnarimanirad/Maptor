...
{ 
    ...
    /// <summary>
    /// Returns Kml representation of the polygon. Note: Z,M values are ignored. Polygon must be in Lat/Long System
    /// </summary>
    /// <returns></returns>
    public override IRI.Maptor.Core.Ogc.Kml.Primitives.PlacemarkType AsPlacemark(Func<Point, Point> projectToGeodeticFunc = null, byte[] color = null)
    {
        ...
        {
            return new IRI.Maptor.Core.Ogc.Kml.Primitives.PlacemarkType();
        }
