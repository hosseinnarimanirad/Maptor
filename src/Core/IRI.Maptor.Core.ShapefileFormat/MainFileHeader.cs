...
public struct MainFileHeader
{
    ...
    {
        get { return new BoundingBox(xMin: XMin, yMin: YMin, xMax: XMax, yMax: YMax); }
    }
    ...
    public MainFileHeader(byte[] values)
    {
        ...
        this.m_Version = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToInt32(values, ShapeConstants.VersionOffset);

        this.m_ShapeType = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToInt32(values, ShapeConstants.ShapeTypeOffset);

        this.m_XMin = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.XMinOffset);

        this.m_YMin = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.YMinOffset);

        this.m_XMax = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.XMaxOffset);

        this.m_YMax = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.YMaxOffset);

        this.m_ZMin = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.ZMinOffset);

        this.m_ZMax = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.ZMaxOffset);

        this.m_MMin = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.MMinOffset);

        this.m_MMax = IRI.Maptor.Core.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.MMaxOffset);
    }
