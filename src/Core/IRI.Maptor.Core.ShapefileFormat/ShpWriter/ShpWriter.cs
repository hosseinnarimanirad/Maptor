...
namespace IRI.Maptor.Core.ShapefileFormat.Writer;
...
public static class ShpWriter
{
    ...
    internal static byte[] WriteMainHeader(IEsriShapeCollection shapes, int fileLength, EsriShapeType shapeType)
    {
        ...
        result.Write(IRI.Maptor.Core.Common.Helpers.StreamHelper.Int32ToBigEndianOrderedBytes(ShapeConstants.FileCode), 0, ShapeConstants.IntegerSize);
        ...
        result.Write(IRI.Maptor.Core.Common.Helpers.StreamHelper.Int32ToBigEndianOrderedBytes(fileLength), 0, ShapeConstants.IntegerSize);
    ...
    internal static byte[] WriteHeaderToByte(int recordNumber, EsriShapeBase shape)
    {
        ...
        result.Write(IRI.Maptor.Core.Common.Helpers.StreamHelper.Int32ToBigEndianOrderedBytes(recordNumber), 0, ShapeConstants.IntegerSize);

        result.Write(IRI.Maptor.Core.Common.Helpers.StreamHelper.Int32ToBigEndianOrderedBytes(shape.ContentLength), 0, ShapeConstants.IntegerSize);
