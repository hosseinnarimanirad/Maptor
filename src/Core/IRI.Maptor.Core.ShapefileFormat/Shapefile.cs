...
using IRI.Maptor.Core.ShapefileFormat.Reader;
using IRI.Maptor.Core.ShapefileFormat.Writer;
...
public static class Shapefile
{
    ...
    //{
    //    //var sourcePrj = IRI.Maptor.Core.ShapefileFormat.Shapefile.GetPrjFileName(shapefileName);
