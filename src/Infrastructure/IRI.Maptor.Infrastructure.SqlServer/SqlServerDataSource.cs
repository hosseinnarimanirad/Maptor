...
public class SqlServerDataSource : VectorDataSource, IEditableVectorDataSource
{
    ...
    protected string MakeSelectCommandWithWkb(byte[] wkbGeometryFilter, bool returnOnlyGeometry)
    {
        ...
        var wkbString = IRI.Maptor.Core.Common.Helpers.HexStringHelper.ToHexStringUsingBitFiddle(wkbGeometryFilter, true);
    ...
    public BoundingBox GetBoundingBox()
    {
        ...
        //return IRI.Maptor.Infrastructure.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.GetBoundingBoxFromEnvelopes(envelopes);
