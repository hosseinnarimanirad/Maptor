...
public class WebApiDataSource : MemoryDataSource
{
        ...
        try
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    throw IRI.Maptor.Core.Versioning.VersioningApiErrors.ToException(response.Error?.Title, response.Error?.Detail)
    ...
    //    var isNew = feature.Status == IRI.Maptor.Core.Common.Enums.FeatureStatus.New;
