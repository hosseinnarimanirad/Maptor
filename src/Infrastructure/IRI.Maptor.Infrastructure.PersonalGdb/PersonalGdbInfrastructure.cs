...
using IRI.Maptor.Infrastructure.PersonalGdb.Xml;
using IRI.Maptor.Core.SpatialReferenceSystem.MapProjections;

namespace IRI.Maptor.Infrastructure.PersonalGdb;
...
public static class PersonalGdbInfrastructure
{
    ...
    public static List<GdbItemColumnInfo> GetFieldInfo(string definition)
    {
        ...
        var featureClassInfos = IRI.Maptor.Core.Common.Helpers.XmlHelper.DeserializeFromXmlString<GdbXml_FeatureClass>(NormalizeSchemaVersion(definition));
    ...
    public static List<GdbCodedValueDomain> GetAllDomains(OleDbConnection connection)
    {
        ...
        {
            var info = IRI.Maptor.Core.Common.Helpers.XmlHelper.DeserializeFromXmlString<GdbXml_CodedValueDomain>(NormalizeSchemaVersion(item.Definition));
