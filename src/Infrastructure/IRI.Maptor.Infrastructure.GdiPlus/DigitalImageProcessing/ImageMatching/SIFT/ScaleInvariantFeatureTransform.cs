...
public class ScaleInvariantFeatureTransform
{
    ...
    {
        Matrix tempMatrix = IRI.Maptor.Infrastructure.GdiPlus.DigitalImageProcessing.GeometricEnhancement.DoubleTheSize(this.originalImage);
        ...
        for (int n = 0; n < depthOfScale; n++)
        {
            ...
            tempMatrix = IRI.Maptor.Infrastructure.GdiPlus.DigitalImageProcessing.GeometricEnhancement.HalveTheSize(scaleSpace[tempIndex]);
    ...
    public void CalculateDifferenceOfGaussians()
    {
        ...
        {
            doGMax.Add(IRI.Maptor.Core.Common.Mathematics.Statistics.GetMax(values));

            doGMin.Add(IRI.Maptor.Core.Common.Mathematics.Statistics.GetMin(values));
        }
    }
