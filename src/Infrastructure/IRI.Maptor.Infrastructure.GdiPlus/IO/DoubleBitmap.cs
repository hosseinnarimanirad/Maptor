...
{
    public static Bitmap DoubleToBitmapLinear(IRI.Maptor.Core.Common.Mathematics.Matrix data)
    {

        Bitmap result = new Bitmap(data.NumberOfColumns, data.NumberOfRows);

        double Max = IRI.Maptor.Core.Common.Mathematics.Statistics.GetMax(data);

        double Min = IRI.Maptor.Core.Common.Mathematics.Statistics.GetMin(data);
    ...
    public static Bitmap DoubleToBitmapSimple(IRI.Maptor.Core.Common.Mathematics.Matrix data)
    {
        Bitmap result = new Bitmap(data.NumberOfColumns, data.NumberOfRows);
