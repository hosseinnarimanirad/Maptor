...
public class GeoPackageDataSource : VectorDataSource, IDisposable
{
    ...
    private void Initialize()
    {
        ...
        GeometryType = MapGeometryType(_geometryColumn.GeometryTypeName) ?? IRI.Maptor.Core.Common.Enums.GeometryType.Polygon;
    ...
    private GeometryType? MapGeometryType(string gpkgTypeName)
    {
        ...
        if (typeName.Contains("POINT"))
            return IRI.Maptor.Core.Common.Enums.GeometryType.Point;

        else if (typeName.Contains("LINESTRING") || typeName.Contains("LINE"))
            return IRI.Maptor.Core.Common.Enums.GeometryType.LineString;

        else if (typeName.Contains("POLYGON"))
            return IRI.Maptor.Core.Common.Enums.GeometryType.Polygon;

        else if (typeName.Contains("MULTIPOINT"))
            return IRI.Maptor.Core.Common.Enums.GeometryType.MultiPoint;

        else if (typeName.Contains("MULTILINESTRING"))
            return IRI.Maptor.Core.Common.Enums.GeometryType.MultiLineString;

        else if (typeName.Contains("MULTIPOLYGON"))
            return IRI.Maptor.Core.Common.Enums.GeometryType.MultiPolygon;
