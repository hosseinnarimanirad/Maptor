# IRI.Maptor.Infrastructure.Sqlite - Implementation Summary
...
├── README.md
└── IRI.Maptor.Infrastructure.Sqlite.csproj
```
...
### Dependencies:
- ✅ `IRI.Maptor.Core.Persistence` (abstractions)
- ✅ `IRI.Maptor.Core.Spatial` (geometry types)
- ✅ `IRI.Maptor.Core.Ogc` (OGC standards)
