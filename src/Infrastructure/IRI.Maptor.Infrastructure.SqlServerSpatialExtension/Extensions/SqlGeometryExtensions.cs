...
using IRI.Maptor.Infrastructure.SqlServerSpatialExtension.Helpers;
...
public static class SqlGeometryExtensions
{
    ...
    {
        return IRI.Maptor.Core.Common.Helpers.HexStringHelper.ToHexStringUsingBitFiddle(geometry?.AsWkb(), true);
    }
    ...
    private static Point GetPoint(SqlGeometry geometry, int index)
    {
        ...
        //return new IRI.Maptor.Core.Common.Primitives.Point(temp.Long.Value, temp.Lat.Value);
    }
    ...
    public static SqlGeometry AsSqlGeometry(this IRI.Maptor.Core.Spatial.Model.TileInfo tile)
    {
        return tile.WebMercatorExtent.AsSqlGeometry();
    }

    public static Geometry<Point> AsGeometry(this IRI.Maptor.Core.Spatial.Model.TileInfo tile)
    {
