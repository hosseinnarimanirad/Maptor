...
- **Added reference** to `IRI.Maptor.Sta.Ogc` in `IRI.Maptor.Jab.Controls.csproj`
...
```csharp
using IRI.Maptor.Jab.Controls.View.Symbology.Sld;
...
```csharp
using IRI.Maptor.Jab.Controls.ViewModel.Symbology.Sld;
...
```xml
<Window xmlns:sld="clr-namespace:IRI.Maptor.Jab.Controls.Views.Symbology.Sld;assembly=IRI.Maptor.Jab.Controls"
        xmlns:vm="clr-namespace:IRI.Maptor.Jab.Controls.ViewModel.Symbology.Sld;assembly=IRI.Maptor.Jab.Controls">
    <Window.DataContext>
...
- Modified: `IRI.Maptor.Jab.Controls.csproj` (added Ogc project reference)
