...
public partial class MapViewer : NotifiableUserControl
{
    ...
    private FrameworkElement GetRightClickOptionsForDraw()
    {
        ...
        var view = new Jab.Common.View.MapOptions.MapThreeOptions(true);
    ...
    private async Task<Response<Geometry<sb.Point>>> Measure(DrawMode mode, EditableFeatureLayerOptions drawingOptions, EditableFeatureLayerOptions editingOptions, Action action, Guid guid)
    {
        ...
        var measureLocatable = new Locateable(new sb.Point(0, 0), AncherFunctionHandlers.BottomCenter) { Element = new IRI.Maptor.Jab.Common.View.MapMarkers.LabelMarker("test") };
        ...
        onMoveForDrawAction = p =>
        {
            ...
            var marker = (measureLayer.Items.First().Element as IRI.Maptor.Jab.Common.View.MapMarkers.LabelMarker);
