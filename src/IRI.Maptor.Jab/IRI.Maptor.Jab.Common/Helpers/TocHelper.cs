...
{
    public static ObservableCollection<ILayer> LoadFiles(string rootDirectory, Func<string, ILayer> vectorLayerLoader, Func<string, RasterLayer> rasterLayerLoader)
    {
        ...
        { 
            var layer = rasterLayerLoader(item);
