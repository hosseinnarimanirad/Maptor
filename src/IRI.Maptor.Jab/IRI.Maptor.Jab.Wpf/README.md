...
[![NuGet](https://img.shields.io/nuget/v/IRI.Maptor.Jab.Wpf?logo=nuget)](https://www.nuget.org/packages/IRI.Maptor.Jab.Wpf/)
...
```bash
dotnet add package IRI.Maptor.Jab.Wpf
```

Requires Windows (WPF). Alternatively, add `IRI.Maptor.Jab.Wpf.csproj` to your solution and
...
```xml
<Window xmlns:maptor="clr-namespace:IRI.Maptor.Jab.Controls;assembly=IRI.Maptor.Jab.Wpf" ...>
    ...
    <Application.Resources>
        <ResourceDictionary>
            <ResourceDictionary.MergedDictionaries>
                ...
                <ResourceDictionary Source="pack://application:,,,/IRI.Maptor.Jab.Wpf;component/Assets/IRI.Maptor.Fonts.xaml"/>
                <ResourceDictionary Source="pack://application:,,,/IRI.Maptor.Jab.Wpf;component/Assets/IRI.Maptor.Colors.xaml"/>
            </ResourceDictionary.MergedDictionaries>
        </ResourceDictionary>
    </Application.Resources>
</Application>
...
- [SLD symbology editor](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Jab/IRI.Maptor.Jab.Wpf/Views/Symbology/Sld/README.md)

---
[NuGet package](https://www.nuget.org/packages/IRI.Maptor.Jab.Wpf/) ·
