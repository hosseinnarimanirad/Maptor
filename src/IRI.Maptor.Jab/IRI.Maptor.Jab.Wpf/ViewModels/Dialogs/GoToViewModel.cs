...
using IRI.Maptor.Jab.Wpf.Models.GoTo;
...
public class GoToViewModel : Notifier
{
    ...
    public DegreeMinuteSecondModel LongitudeDms
    {
        get { return _longitudeDms; }
    }

    private readonly DegreeMinuteSecondModel _latitudeDms;

    public DegreeMinuteSecondModel LatitudeDms
    {
    ...
    public GoToViewModel(Action<Point> requestPanTo, Action<Point> requestZoomTo, List<HamburgerGoToMenuItem> items = null)
    {
        ...
        _longitudeDms = new DegreeMinuteSecondModel();

        _longitudeDms.OnValueChanged -= OnValueChangedHandler;
        _longitudeDms.OnValueChanged += OnValueChangedHandler;

        _latitudeDms = new DegreeMinuteSecondModel();
    ...
    public void SetWebMercatorPoint(Point point)
    {
