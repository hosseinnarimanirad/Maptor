...
public partial class MapViewer : NotifiableUserControl
{
    ...
    private async Task AddTileServiceLayerAsync(TileServiceLayer layer, TileInfo tile)
    {
        try
        {
            ...
            try
            {
                fill = new ImageBrush(IRI.Maptor.Jab.Wpf.Helpers.ImageUtility.CreateBitmapImage(geoImage.Image));
            }
            catch (Exception ex)
            {
                fill = new ImageBrush();
    ...
    public void Print()
    {
        //IRI.Maptor.Jab.Wpf.Helpers.PrintHelper.Print(this.mapView);
        IRI.Maptor.Jab.Wpf.Helpers.PrintHelper.Print(this);
    }
    ...
    {
        var vm = new IRI.Maptor.Jab.Wpf.ViewModels.Map.FeatureChangesViewModel(feature, fields);
