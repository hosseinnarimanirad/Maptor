...
- **Added reference** to `IRI.Maptor.Sta.Ogc` in `IRI.Maptor.Jab.Wpf.csproj`
...
<Window xmlns:sld="clr-namespace:IRI.Maptor.Jab.Controls.Symbology.Sld"
        xmlns:vm="clr-namespace:IRI.Maptor.Jab.Wpf.ViewModels.Symbology;assembly=IRI.Maptor.Jab.Wpf">
    <Window.DataContext>
...
- Modified: `IRI.Maptor.Jab.Wpf.csproj` (added Ogc project reference)
