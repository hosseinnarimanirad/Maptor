...
public class MapzenGeometry
{
    ...
    //public IRI.Maptor.Sta.Common.Primitives.Geometry<Point> ParseToGeometry()
    //{
    //    if (type.ToLower().Trim() == "linestring")
    //    {
    //        return IRI.Maptor.Sta.Common.Primitives.Geometry<Point>.ParseLineStringToGeometry(Points, IRI.Maptor.Sta.Common.Primitives.GeometryType.LineString, true);
    //    }
    //    else if (type.ToLower().Trim() == "polygon")
    //    {
    //        return IRI.Maptor.Sta.Common.Primitives.Geometry<Point>.ParsePolygonToGeometry(Rings, IRI.Maptor.Sta.Common.Primitives.GeometryType.Polygon, true);
    //    }
    //    else
    //    {
    //        throw new NotImplementedException();
