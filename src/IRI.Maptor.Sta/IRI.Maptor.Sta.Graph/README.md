...
[![NuGet](https://img.shields.io/nuget/v/IRI.Maptor.Sta.Graph?logo=nuget)](https://www.nuget.org/packages/IRI.Maptor.Sta.Graph/)
...
- [Graph representation](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Sta/IRI.Maptor.Sta.Graph/GraphRepresentation/README.md)
- [Search (BFS/DFS)](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Sta/IRI.Maptor.Sta.Graph/Search/README.md)
- [Shortest paths](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Sta/IRI.Maptor.Sta.Graph/ShortestPaths/README.md)
- [Minimum spanning tree](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Sta/IRI.Maptor.Sta.Graph/MinimumSpanningTree/README.md)
- [Minimum cut](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Sta/IRI.Maptor.Sta.Graph/MinCut/README.md)
- [Clustering](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Sta/IRI.Maptor.Sta.Graph/Clustering/README.md)

---
[NuGet package](https://www.nuget.org/packages/IRI.Maptor.Sta.Graph/) · [Report issues](https://github.com/hosseinnarimanirad/Maptor/issues) · [Back to IRI.Maptor.Sta](https://github.com/hosseinnarimanirad/Maptor/blob/master/src/IRI.Maptor.Sta/README.md)
