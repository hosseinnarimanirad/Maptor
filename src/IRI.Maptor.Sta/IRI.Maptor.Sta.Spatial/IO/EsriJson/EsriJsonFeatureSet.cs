...
public class EsriJsonFeatureSet
{
    ...
    public FeatureSet<Point> AsFeatureSet()
    {
        ...
        {
            EsriJsonGeometryType.esriGeometryPoint => IRI.Maptor.Sta.Common.Enums.GeometryType.Point,
            EsriJsonGeometryType.esriGeometryMultipoint => IRI.Maptor.Sta.Common.Enums.GeometryType.MultiPoint,
            EsriJsonGeometryType.esriGeometryPolyline => IRI.Maptor.Sta.Common.Enums.GeometryType.LineString,
            EsriJsonGeometryType.esriGeometryPolygon => IRI.Maptor.Sta.Common.Enums.GeometryType.Polygon,
    ...
    public static EsriJsonFeatureSet? Parse(FeatureSet<Point> featureSet)
    {
        ...
        {
            IRI.Maptor.Sta.Common.Enums.GeometryType.Point => EsriJsonGeometryType.esriGeometryPoint,
            IRI.Maptor.Sta.Common.Enums.GeometryType.MultiPoint => EsriJsonGeometryType.esriGeometryMultipoint,
            IRI.Maptor.Sta.Common.Enums.GeometryType.LineString => EsriJsonGeometryType.esriGeometryPolyline,
            IRI.Maptor.Sta.Common.Enums.GeometryType.MultiLineString => EsriJsonGeometryType.esriGeometryPolyline,
            IRI.Maptor.Sta.Common.Enums.GeometryType.Polygon => EsriJsonGeometryType.esriGeometryPolygon,
            IRI.Maptor.Sta.Common.Enums.GeometryType.MultiPolygon => EsriJsonGeometryType.esriGeometryPolygon,
