...
[IRI.Maptor.Sta.Spatial](../../README.md) package; the EPS support in
...
`IRI.Maptor.Sta.Spatial.IO.Svg`; `RgbColor` in `IRI.Maptor.Sta.Spatial.IO.Dxf`.
...
Reader extensions live in `IRI.Maptor.Sta.Spatial.IO.Svg` (`SvgReaderExtensions`); the underlying
