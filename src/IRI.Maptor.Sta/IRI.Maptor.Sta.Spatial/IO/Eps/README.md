...
[IRI.Maptor.Sta.Spatial](../../README.md) package and mirrors the API of the
...
`IRI.Maptor.Sta.Spatial.IO.Eps`; `RgbColor` in `IRI.Maptor.Sta.Spatial.IO.Dxf`.
...
Reader extensions live in `IRI.Maptor.Sta.Spatial.IO.Eps` (`EpsReaderExtensions`); the underlying
...
var options = new EpsOptions
{
    ...
    Creator = "My Application",               // default "IRI.Maptor.Sta.Spatial"
    Title = "My Document"
};
```
