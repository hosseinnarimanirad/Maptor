...
//[Obsolete("Incomplete implementation with broken vertex-code keying (Point.GetHashCode() used as key). Use VoronoiDiagram instead.")]
//public class VoronoiDiagram_old
//{
