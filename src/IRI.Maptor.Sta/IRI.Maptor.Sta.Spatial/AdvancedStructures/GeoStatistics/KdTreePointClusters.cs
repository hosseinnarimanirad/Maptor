    ...
    public void GetClusters(Func<T, T, bool> groupLogic)
    {
        ...
        if (_allSingleMembers?.Count > 0)
        {
            ...
            for (int i = 1; i < _allSingleMembers.Count; i++)
            {
                ...
                var nearestGroup = Groups.FindNearestNeighbour(tempGroup, ((g1, g2) => IRI.Maptor.Sta.Spatial.Analysis.SpatialUtility.CalculateEuclideanDistance(g1.Center, g2.Center)));
