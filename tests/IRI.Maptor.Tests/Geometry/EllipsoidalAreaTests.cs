...
public class EllipsoidalAreaTests
{
    ...
    public void Compare_CalculateSphereArea_With_SqlGeography(string wkt)
    {
        ...
        var geometry = Geometry<IRI.Maptor.Core.Common.Primitives.Point>.FromWkt(wkt, Wgs84Srid);
        var newGeo = geometry.Project(new IRI.Maptor.Core.SpatialReferenceSystem.MapProjections.CylindricalEqualArea());
