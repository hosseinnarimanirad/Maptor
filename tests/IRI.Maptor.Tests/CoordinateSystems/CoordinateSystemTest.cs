...
public class CoordinateSystemTest
{
    ...
    public void TestLccNahrawan_FromGeodetic()
    {
        ...
        // Act
        var projectedPoint = IRI.Maptor.Core.SpatialReferenceSystem.MapProjections.SrsBases.LccNahrawan.FromGeodetic(nahrawanGeodeticPoint);
    ...
    public void TestGeodeticToAT()
    {
        ...
        var testPoint = new IRI.Maptor.Core.Common.Primitives.Point(lambda, phi);
