...
namespace IRI.Maptor.Tests.Benchmarking;
...
static class ShapefileToBitmap
{
    ...
    public static void Go()
    {
        ...
        //*********************************************************
        //
        var shapes = IRI.Maptor.Core.ShapefileFormat.Shapefile.ReadShapes(dialog.FileName);
        //
        //*********************************************************
        watch.Stop();                                           //*
        ...
        //StreamGeometry geo =
        //    IRI.Maptor.Presentation.Wpf.Converter.StreamGeometryRenderer.ParseSqlGeometry(geometries/*, p => transform.Transform(p)*/);
        //
        //*********************************************************
        watch.Stop();                                           //*
