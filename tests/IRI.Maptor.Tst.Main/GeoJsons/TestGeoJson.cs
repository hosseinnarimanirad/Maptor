...
public class TestGeoJson
{
    ...
    //{
    //    //Test Point
    //    var point = Geometry<Point>.Create(30, 10).AsGeoJson().Serialize(false).Replace(" ", string.Empty);
    ...
    //    IGeoJsonGeometry multiPoint = GeoJson.DeserializeGeometry(multiPointString);
    ...
    //    IGeoJsonGeometry lineString = GeoJson.DeserializeGeometry(lineStringString);
    ...
    //    IGeoJsonGeometry multiLineString = GeoJson.DeserializeGeometry(multiLineStringString);
    ...
    //    IGeoJsonGeometry polygon1 = GeoJson.DeserializeGeometry(polygonString1);
    ...
    //    IGeoJsonGeometry polygon2 = GeoJson.DeserializeGeometry(polygonString2);
    ...
    //    IGeoJsonGeometry multiPolygon1 = GeoJson.DeserializeGeometry(multiPolygonString1);
    ...
    //    IGeoJsonGeometry multiPolygon2 = GeoJson.DeserializeGeometry(multiPolygonString2);
    ...
    private string ReadFile(string fileName)
    {
        ...
        var resourceName = $"IRI.Maptor.Tst.Main.Assets.GeoJsonSamples.{fileName}";
