...
static class ShapefileToBitmap
{
    ...
    public static void Go()
    {
        ...
        //*********************************************************
        //
        var shapes = IRI.Maptor.Sta.ShapefileFormat.Shapefile.ReadShapes(dialog.FileName);
        //
        //*********************************************************
        watch.Stop();                                           //*
        ...
        //StreamGeometry geo =
        //    IRI.Maptor.Jab.Wpf.Converter.StreamGeometryRenderer.ParseSqlGeometry(geometries/*, p => transform.Transform(p)*/);
        //
        //*********************************************************
        watch.Stop();                                           //*
